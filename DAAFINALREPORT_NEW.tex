...
\begin{figure}[htbp]
    \centering
    \framebox[0.8\textwidth]{\vbox to 6cm{\vfill\centering [Image Placeholder: Dashboard Interface]\vfill}}
...
\begin{figure}[htbp]
    \centering
    \framebox[0.8\textwidth]{\vbox to 6cm{\vfill\centering [Image Placeholder: Live Playback Simulation Engine]\vfill}}
...
\begin{figure}[htbp]
    \centering
    \framebox[0.8\textwidth]{\vbox to 6cm{\vfill\centering [Image Placeholder: Analytics \& Performance Dashboard]\vfill}}
