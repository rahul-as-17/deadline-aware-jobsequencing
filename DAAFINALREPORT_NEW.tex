...
\begin{figure}[h]
    \centering
    \rect(0,0)(10,6)
    \node at (5,3) [draw, fill=gray!20, minimum width=8cm, minimum height=3.5cm, font=\small] {Image Placeholder 1: Dashboard Interface};
...
\begin{figure}[h]
    \centering
    \node at (5,3) [draw, fill=gray!20, minimum width=8cm, minimum height=3.5cm, font=\small] {Image Placeholder 2: Live Playback Simulation Page};
...
\begin{figure}[h]
    \centering
    \node at (5,3) [draw, fill=gray!20, minimum width=8cm, minimum height=3.5cm, font=\small] {Image Placeholder 3: Dynamic Rescheduling Page};
