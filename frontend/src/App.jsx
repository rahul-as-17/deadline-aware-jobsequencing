...
import { LayoutDashboard, Cpu, GitCompare, BarChart3, Brain, Activity, Zap } from 'lucide-react';
...
export default function App() {
  ...
  const ActivePage = { dashboard: Dashboard, scheduler: Scheduler, compare: Compare, analytics: Analytics, performance: PerformanceAnalysis, train: TrainAI }[page];
